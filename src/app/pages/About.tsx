...
import Realpop_Team from '../../assets/images/us.png'
...
const About = (props: Props) => {
  return (
    <>
      <section id="about" className="container my-[100px] h-full relative flex flex-col gap-y-[50px]">
        {/* About Realpop */}
          <div className="about-realpop relative flex flex-col items-center">
            <img src={ Realpop } alt="Realpop Social Preview" className="z-10 w-[400px] h-[200px] rounded-[32px]" />
            <div className="text-bg  pb-[25px] mt-[-75px] flex flex-col items-center bg-opaque-black w-[450px] rounded-[32px]">
              <div className="text-holder mt-[75px] w-[400px] gap-y-[8px]">
          ...
          <div className="credits relative flex flex-col items-center">
            <img src={ Realpop } alt="Realpop Team" className="z-10 w-[400px] h-[200px] rounded-[32px]" />
            <div className="text-bg  pb-[25px] mt-[-75px] flex flex-col items-center bg-opaque-black w-[450px] rounded-[32px]">
              <div className="text-holder mt-[75px] w-[400px] gap-y-[8px]">
                ...
                <div className="credits-holder flex flex-col gap-y-[12px] ">
                  ...
                  <p className="w-[400px]"><span className="text-electric-pink">●</span> JYP Entertainment. (2023, Jul 11). NMIXX "Party O&apos;Clock" M/V [Video]. YouTube.&nbsp;
                  ...
                  <p className="w-[400px]"><span className="text-electric-pink">●</span> HYBE LABELS. (2023, Jul 7). NewJeans (뉴진스) 'Super Shy' Official MV [Video]. YouTube.&nbsp;
                  ...
                  <p className="w-[400px]"><span className="text-electric-pink">●</span> SMTOWN. (2023, May 8). aespa 에스파 'Spicy' MV [Video]. YouTube.&nbsp;
                  ...
                  <p className="w-[400px]"><span className="text-electric-pink">●</span> HYBE LABELS. (2023, May 1). LE SSERAFIM (르세라핌) 'UNFORGIVEN (feat. Nile Rodgers)' OFFICIAL M/V [Video]. YouTube.&nbsp;
                  ...
                  <p className="w-[400px]"><span className="text-electric-pink">●</span> JYP Entertainment. (2017, Dec 11). TWICE "Heart Shaker" M/V [Video]. YouTube.&nbsp;
                  ...
                  <p className="w-[400px]"><span className="text-electric-pink">●</span> JYP Entertainment. (2022, Sep 19). NMIXX "DICE" M/V [Video]. YouTube.&nbsp;
                  ...
                  <p className="w-[400px]"><span className="text-electric-pink">●</span> HYBE LABELS. (2023, Jan 3). NewJeans (뉴진스) 'OMG' Official MV (Performance ver.1) [Video]. YouTube.&nbsp;
                  ...
                  <p className="w-[400px]"><span className="text-electric-pink">●</span> HYBE LABELS. (2022, Oct 16). LE SSERAFIM (르세라핌) 'ANTIFRAGILE' OFFICIAL M/V [Video]. YouTube.&nbsp;
                  ...
                  <hr />
                  <h2>Assets:</h2>
                  <p className="w-[400px]"><span className="text-electric-pink">●</span><Link to="https://www.flaticon.com/free-icons/hand-heart" className="cursor-pointer underline text-blue-400" target="_blank">Hand-heart icons</Link> created by kerismaker - Flaticon&nbsp;
                  </p>
                </div>
              </div>
            </div>
