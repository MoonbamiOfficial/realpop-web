...
const Footer = (props: Props) => {
  return (
    <>
      <div className="footer-bg -z-50 absolute border-t-[8px] border-electric-pink bg-opaque-black w-full h-[750px] "></div>
      <footer className="container z-50 relative mx-auto bottom-0 w-full h-[750px] px-[15px] sm:px-[25px] md:px-[50px] lg:px-[75px] xl:px-[100px] 2xl:px-[150px] premium:px-[200px]">
